...
1. Ensure that you have forked the <a href="https://github.com/badrinathvm/StackCardView">StackCardView</a> repo and are creating a pull request from that branch. You will not be able to directly push the StepperView main repo.
